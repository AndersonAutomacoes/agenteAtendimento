...
public final class RagSystemPromptComposer {
    ...
    private static final String SCHEDULING_POLICY =
            "Agendamento: você tem permissão para agendar serviços. "
                    ...
                    + "cancel_appointment do agendamento correcto primeiro. Depois de cancel_appointment ter sucesso, "
                    + "NÃO volte a chamar get_active_appointments nem mostre nova lista só porque ainda há outros "
                    + "agendamentos — só se o cliente pedir explicitamente gerir/agendar de novo ou ver os agendamentos. "
                    + "Finalize com uma frase curta se quiser ser cordial (ou deixe a resposta mínima se o modelo não "
                    + "acrescentar texto). Para marcar novo horário, aí sim siga disponibilidade e confirmação. "
